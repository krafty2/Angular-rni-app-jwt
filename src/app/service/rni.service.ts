...
import { Observable, catchError, forkJoin, merge, of } from 'rxjs';
...
export class RniService {
  ...
  private mapRequestUrl = "http://localhost:8080/pub/mapRni";
  ...
  private villes = "http://localhost:8080/pub/villes";
